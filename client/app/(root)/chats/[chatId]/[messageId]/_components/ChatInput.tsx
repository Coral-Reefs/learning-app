...
import EmojiPickerComponent from "../../_components/input/components/EmojiPickerComponent";
import FileUpload from "../../_components/input/components/FileUpload";
import CaptureAudio from "../../_components/input/components/CaptureAudio";
...
const ChatInput = ({ setReplying, replying }: Props) => {
  const { chatId, messageId } = useChat();
